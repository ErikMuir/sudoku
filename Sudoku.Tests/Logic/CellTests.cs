...
public class CellTests
{
    ...
    {
        var testObject = new Cell(row, col);
    ...
    public void CopyConstructor_Returns_Copy()
    {
        ...
        for (var i = 0; i < original.Candidates.Count; i++)
        {
    ...
    {
        var original = new Clue(1, 2, 3);
        var exception = Record.Exception(() => new Cell(original));
        Assert.NotNull(exception);
        Assert.IsType<SudokuException>(exception);
    }
