...
namespace Sudoku.Tests
{
    public class CellTests
    {
        ...
        {
            Cell actual = Cell.Parse(val);
            Assert.NotNull(actual);
            // and just for fun...
            string newVal = actual.ToString();
        ...
        {
            Exception exception = Record.Exception(() => Cell.Parse(val));
            Assert.NotNull(exception);
            Assert.IsType<SudokuException>(exception);
        ...
        {
            Cell testObject = new(col, 0);
            string actual = testObject.ToString().Substring(0, 1);
        ...
        {
            Cell testObject = new(0, row);
            string actual = testObject.ToString().Substring(1, 1);
        ...
        {
            Cell testObject = new(0, 0, val);
            string actual = testObject.ToString().Substring(2, 1);
        ...
        {
            Cell testObject = new(0, 0, 9);
            string actual = testObject.ToString().Substring(3, 1);
            Assert.Equal("0", actual);
        }
